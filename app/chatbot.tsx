...
const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a_ar: 'بعد إرسال طلبك يستطيع أكثر من فني تقديم عرض سعر عليه. تشاهد العروض مع تقييم كل فني، وتقبل عرضاً واحداً أو ترفض ما لا يناسبك. بمجرد قبول عرض يُسند الطلب لذلك الفني وتُغلق باقي العروض تلقائياً.',
    a_en: 'After you submit a request, multiple technicians can quote on it. You see each offer with the technician\'s rating, and you accept one or decline the rest. Once you accept, the request is assigned to that technician and the other offers close automatically.',
  ...
  },
  {
    ...
    a_ar: 'عند إنشاء الطلب يظهر لك سعر تقديري مبدئي (وليس سعراً نهائياً). بعدها يرسل الفنيون عروض أسعارهم وأنت تختار. وبعد الفحص الفعلي يؤكد الفني السعر النهائي وأنت توافق عليه قبل بدء أي إصلاح.',
    a_en: 'When you create a request you see an initial estimated price (not a final one). Technicians then send their own offers and you choose. After the actual inspection the technician confirms the final quote, which you approve before any repair starts.',
